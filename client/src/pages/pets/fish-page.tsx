...
export default function FishPage() {
  ...
  const { data: listings, isLoading } = useQuery<PetListing[]>({
    ...
    select: (data) => {
      // Filter for fish listings only
      const fishListings = data.filter(listing => listing.petType === "fish" && listing.approved);
      
      // Sort listings based on sortBy
      return [...fishListings].sort((a, b) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <PetTypeHeader activeType="fish" />
      
      <div className="container mx-auto py-6 px-4">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
          <h2 className="text-2xl font-bold mb-4 sm:mb-0">Fish</h2>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12">
            <h3 className="text-xl font-medium text-gray-600 mb-4">No fish listings found</h3>
