...
export default function BirdsPage() {
  ...
  const { data: listings, isLoading } = useQuery<PetListing[]>({
    ...
    select: (data) => {
      // Filter for bird listings only
      const birdListings = data.filter(listing => listing.petType === "bird" && listing.approved);
      
      // Sort listings based on sortBy
      return [...birdListings].sort((a, b) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <PetTypeHeader activeType="bird" />
      
      <div className="container mx-auto py-6 px-4">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
          <h2 className="text-2xl font-bold mb-4 sm:mb-0">Birds</h2>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12">
            <h3 className="text-xl font-medium text-gray-600 mb-4">No bird listings found</h3>
